...
public class FTBlocks {
    ...
    public static final RegistryObject<Block> FISHTRAP = BLOCKS.register("fishtrap", () -> new FishtrapBlock(BlockBehaviour.Properties.of(Material.WOOL, MaterialColor.COLOR_BROWN).noOcclusion()));
